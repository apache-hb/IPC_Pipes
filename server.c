...
|
|   Purpose: Lab/Assignment 6. Server Code 
|  
...
|
|   Inspiration: Some of the code was taken and restructured from the lecture slides on
|                blackboard written by Professor Jacques Beland
|       
|      
|
|------------------------------------------------------------------*/
...
int main( int argc, char *argv[] )
{
    ...
    char* destination = "lab6_sourcefile_local_clone.txt"; //destination of file copy
